...
<select  v-model="countOperation" placeholder='Operation' >
  ...
  <option value="141">Pointage au service</option>
   <option value="503">Presence</option>
   <option value="502">scaneur pour ticket</option>
    <option value="607">générez un Ticket</option>
</select>
</div>
...
:
 ...
 <div v-if='geolocation' class="modal-body"> 
  <p class="mx-auto p-auto bg-info shadow-lg"> 
 <span>Continent:</span> {{geolocation.continent}}<br/>   
 <span>Pays:</span> {{geolocation.country}} {{geolocation.flag.emoji}}<br/>  
  <span>Capital:</span> {{geolocation.city}}<br/> 
<span>Addresse IP:</span> {{geolocation.ip_address}}<br/>
<span> Reseau:</span> {{geolocation.connection.organization_name}}<br/>
...
<li class="nav-item P-3 m-3 lessonList">
 <router-link class="nav-link badge bg-dark router-link "  to="/carteUp"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-qr-code-scan ball" viewBox="0 0 16 16">
  ...
  <path d="M9 2h5v5H9V2Zm1 1v3h3V3h-3ZM8 8v2h1v1H8v1h2v-2h1v2h1v-1h2v-1h-3V8H8Zm2 2H9V9h1v1Zm4 2h-1v1h-2v1h3v-2Zm-4 2v-1H8v1h2Z"/>
  <path d="M12 9h2V8h-2v1Z"/>
</svg>CHARGEZ QRCODE DE PRODUIT</router-link>
  </li>
 ...
 <router-link class="nav-link badge bg-dark router-link"  to="/qrSanProfcarte"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-qr-code-scan ball" viewBox="0 0 16 16">
  ...
  <path d="M9 2h5v5H9V2Zm1 1v3h3V3h-3ZM8 8v2h1v1H8v1h2v-2h1v2h1v-1h2v-1h-3V8H8Zm2 2H9V9h1v1Zm4 2h-1v1h-2v1h3v-2Zm-4 2v-1H8v1h2Z"/>
  <path d="M12 9h2V8h-2v1Z"/>
</svg> SCANNE UNE CARTE PRO</router-link>
  </li>
...
<li class="nav-item P-3 m-3 lessonList">
 ...
 <router-link class="nav-link badge bg-dark router-link"  to="/openaiImage"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-reddit  ball" viewBox="0 0 16 16">
  ...
  <li class="nav-item P-3 m-3 lessonList " v-if="user.role==='Owner' || user.role==='Boutique'">
...
<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">
 ...
 <router-link class="nav-link badge bg-dark router-link"  to="/getAllProfCarte"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-reddit  ball" viewBox="0 0 16 16">
  ...
  <li class="nav-item P-3 m-3 lessonList router-link" v-if="user.role==='Owner'">
 <router-link class="nav-link badge bg-dark router-link"  to="/metier"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-reddit  ball" viewBox="0 0 16 16">
  <path d="M6.167 8a.831.831 0 0 0-.83.83c0 .459.372.84.83.831a.831.831 0 0 0 0-1.661zm1.843 3.647c.315 0 1.403-.038 1.976-.611a.232.232 0 0 0 0-.306.213.213 0 0 0-.306 0c-.353.363-1.126.487-1.67.487-.545 0-1.308-.124-1.671-.487a.213.213 0 0 0-.306 0 .213.213 0 0 0 0 .306c.564.563 1.652.61 1.977.61zm.992-2.807c0 .458.373.83.831.83.458 0 .83-.381.83-.83a.831.831 0 0 0-1.66 0z"/>
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.828-1.165c-.315 0-.602.124-.812.325-.801-.573-1.9-.945-3.121-.993l.534-2.501 1.738.372a.83.83 0 1 0 .83-.869.83.83 0 0 0-.744.468l-1.938-.41a.203.203 0 0 0-.153.028.186.186 0 0 0-.086.134l-.592 2.788c-1.24.038-2.358.41-3.17.992-.21-.2-.496-.324-.81-.324a1.163 1.163 0 0 0-.478 2.224c-.02.115-.029.23-.029.353 0 1.795 2.091 3.256 4.669 3.256 2.577 0 4.668-1.451 4.668-3.256 0-.114-.01-.238-.029-.353.401-.181.688-.592.688-1.069 0-.65-.525-1.165-1.165-1.165z"/>
</svg>METIER</router-link>
  </li>
<li class="nav-item P-3 m-3 lessonList router-link" >
 <router-link class="nav-link badge bg-dark router-link"  to="/ticket:id"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-reddit  ball" viewBox="0 0 16 16">
  <path d="M6.167 8a.831.831 0 0 0-.83.83c0 .459.372.84.83.831a.831.831 0 0 0 0-1.661zm1.843 3.647c.315 0 1.403-.038 1.976-.611a.232.232 0 0 0 0-.306.213.213 0 0 0-.306 0c-.353.363-1.126.487-1.67.487-.545 0-1.308-.124-1.671-.487a.213.213 0 0 0-.306 0 .213.213 0 0 0 0 .306c.564.563 1.652.61 1.977.61zm.992-2.807c0 .458.373.83.831.83.458 0 .83-.381.83-.83a.831.831 0 0 0-1.66 0z"/>
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.828-1.165c-.315 0-.602.124-.812.325-.801-.573-1.9-.945-3.121-.993l.534-2.501 1.738.372a.83.83 0 1 0 .83-.869.83.83 0 0 0-.744.468l-1.938-.41a.203.203 0 0 0-.153.028.186.186 0 0 0-.086.134l-.592 2.788c-1.24.038-2.358.41-3.17.992-.21-.2-.496-.324-.81-.324a1.163 1.163 0 0 0-.478 2.224c-.02.115-.029.23-.029.353 0 1.795 2.091 3.256 4.669 3.256 2.577 0 4.668-1.451 4.668-3.256 0-.114-.01-.238-.029-.353.401-.181.688-.592.688-1.069 0-.65-.525-1.165-1.165-1.165z"/>
</svg>TICKET</router-link>
  </li>
